...
// Tamu hanya bisa akses dashboard
if (role === 'tamu' && page !== 'dashboard') {
  page = 'dashboard';
}

// Petugas hanya bisa akses terminal masing-masing
if (role === 'petugas') {
  if (terminal === 'PURBALINGGA' && page === 'input_banjarnegara') page = 'input_purbalingga';
  if (terminal === 'BANJARNEGARA' && page === 'input_purbalingga') page = 'input_banjarnegara';
  // Kalau akses dashboard redirect ke halaman input masing-masing
  if (page === 'dashboard') {
    if (terminal === 'PURBALINGGA') page = 'input_purbalingga';
    else if (terminal === 'BANJARNEGARA') page = 'input_banjarnegara';
  }
}
//INI BATASNYA
  try {
